...
@app.route('/')
def index():
    return render_template('index.html', predicted_letter=last_predicted_letter)
...
def detect_objects():
    ...
    model = YOLO("C:\\Users\\yigit\\Desktop\\yolo_try\\yolo_try\\runs\\detect\\train8\\weights\\best.pt")
    ...
    while True:
        ...
        if consecutive_predictions >= 5:  # Assuming 10 frames per second
